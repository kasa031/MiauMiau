# Omfattende TODO-liste for MiauMiau 🐱

## ✅ Fullførte oppgaver (siste oppdatering)

### Funksjonalitet
- [x] Gruppesystem med passordbeskyttelse
- [x] Vennsystem med gaver og meldinger
- [x] Oppdragssystem med 8 oppdragstyper
...
- [ ] **Partikkeleffekter** - Flere typer partikler for ulike handlinger
...
### Sikkerhet
- [ ] **Input-validering** - Bedre validering av brukerinput
- [ ] **XSS-beskyttelse** - Forbedret beskyttelse mot XSS
...
- [ ] **API-dokumentasjon** - Dokumenter alle API-kall
...
- [ ] **Push-notifikasjoner** - Varsler når katten trenger noe
- [ ] **E-post varsler** - E-post når viktige hendelser skjer
...
- [ ] **Cloud backup** - Automatisk backup til skyen
...
*Sist oppdatert: Etter fiksing av stat-oppdateringer og implementering av alle achievements*
